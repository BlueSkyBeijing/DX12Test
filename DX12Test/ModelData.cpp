...
std::vector<DirectX::XMFLOAT3> ModelData::points
{
...
std::vector<uint32_t> ModelData::patches
{
	// rim
...
std::vector<DirectX::XMFLOAT4X4> ModelData::patchesTransforms
{
...
std::vector<DirectX::XMFLOAT3> ModelData::patchesColors
{
