...
Renderable::Renderable(UINT bufferCount, string name, LONG width, LONG height) : bufferCount{ bufferCount }, swapChainBuffers(bufferCount)
{
...
void Renderable::createWindow(string name, LONG width, LONG height)
{
	window = make_shared<Window>(width, height, name.c_str());
}

void Renderable::createFactory()
{
#if defined(_DEBUG) 
...
void Renderable::createCommandQueue()
{
...
void Renderable::createSwapChain()
{
...
void Renderable::getSwapChainBuffers()
{
	for (UINT i{ 0 }; i < bufferCount; i++)
	{
...
void Renderable::createDescriptoprHeapRtv()
{
...
void Renderable::createDepthStencilBuffer()
{
...
void Renderable::createDescriptorHeapDepthStencil()
{
	D3D12_DESCRIPTOR_HEAP_DESC heapDesc;
	ZeroMemory(&heapDesc, sizeof(heapDesc));
...
void Renderable::createCommandAllocators()
{
	for (UINT i{ 0 }; i < bufferCount; i++)
	{
...
void Renderable::createCommandList()
{
...
void Renderable::createFenceEventHandle()
{
...
void Renderable::waitFrameComplete(UINT frameIndex)
{
